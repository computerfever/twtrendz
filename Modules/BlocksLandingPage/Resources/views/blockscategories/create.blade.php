...
@section('title', trans('Create block Category'))
...
@section('page_header')
	<div class="page-title">				
		...
		<h1><span class="text-gear"><span class="material-symbols-rounded">view_list</span> @lang('Create Block Category')</span></h1>
	</div>
@endsection
