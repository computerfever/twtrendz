...
class BlocksLandingPageController extends Controller{
	...
	public function store(Request $request){
		...
		if($image != ''){
			...
			if(checkIsAwsS3()){
				Storage::disk('s3')->put("storage/thumb_blocks/$new_name", file_get_contents($request->thumb));
			}else{
	...
	public function update(Request $request, $id){
		...
		if($image != ''){
			...
			if(checkIsAwsS3()){
				Storage::disk('s3')->put("storage/thumb_blocks/$image_name", file_get_contents($request->thumb));
			}else{
