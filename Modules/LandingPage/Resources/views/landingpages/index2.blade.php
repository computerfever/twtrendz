@extends('core::layouts.frontend', ['menu' => 'customerLandingpages'])
...
@section('page_header')
  <div class="page-title">        
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1>
        <span class="text-gear"><span class="material-symbols-rounded">format_list_bulleted</span> @lang('Cutomer Landing Page Designs')</span>
      </h1>
          ...
          <table class="table table-bordered table-striped">
            ...
            <tbody class="table-group-divider">
              ...
              <tr>
                ...
                <td>
                  @if($item->id == Auth::user()->landing_page)
                ...
                <td align="center">
                  ...
                  <div class="dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" style="">
                      ...
                      @endif
                      <a href="{{ route('landingpages.makeItPublish', $item->code) }}" class="dropdown-item">Publish</a>
